        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-800 rounded-lg p-4 text-center">
              <h3 className="text-white font-semibold mb-2">Theo dõi chúng tôi</h3>
              <p className="text-blue-200 text-sm mb-4">
                Cập nhật tin tức và dịch vụ mới nhất
              </p>

              {/* Facebook Page Plugin */}
              <div className="flex justify-center">
                <iframe
                  src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fdichvutuvansetupnhahangquancafe&tabs=timeline&width=340&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId"
                  width="340"
                  height="250"
